...
const objectives = [
  { num: '01', title: 'Connect Employers with Candidates', desc: 'To provide effective recruitment and staffing solutions that meet operational requirements.' },
  { num: '02', title: 'Support Candidates', desc: 'To help individuals identify employment opportunities that match their skills and experience.' },
  { num: '03', title: 'Maintain Professional Standards', desc: 'To operate transparent and responsible recruitment processes at all times.' },
  { num: '04', title: 'Develop Long-Term Relationships', desc: 'To build lasting relationships with employers, candidates and business partners.' },
  { num: '05', title: 'Support Workforce Flexibility', desc: 'To help organisations respond to changing staffing requirements quickly and efficiently.' },
  { num: '06', title: 'Promote Equal Opportunity', desc: 'To provide fair and inclusive recruitment processes accessible to all candidates.' },
  { num: '07', title: 'Maintain Appropriate Compliance', desc: 'To undertake relevant checks and processes according to the role, sector and applicable requirements.' },
];
      ...
      <div className="container max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-14 fade-up">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Seven core commitments that guide how we operate, serve our clients, and support our candidates.
          </p>
        </div>
